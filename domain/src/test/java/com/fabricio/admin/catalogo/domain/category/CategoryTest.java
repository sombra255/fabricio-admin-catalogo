...
import com.fabricio.admin.catalogo.domain.UnitTest;
import com.fabricio.admin.catalogo.domain.exceptions.DomainException;
import com.fabricio.admin.catalogo.domain.validation.handler.ThrowsValidationHandler;
...
public class CategoryTest extends UnitTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String expectedName = """
                Desta maneira, o julgamento imparcial das eventualidades afeta positivamente
                a correta previsão das diretrizes de desenvolvimento para o futuro.
                 Gostaria de enfatizar que a valorização de fatores subjetivos maximiza as possibilidades
                  por conta das condições financeiras e administrativas exigidas. Neste sentido,
                   a adoção de políticas descentralizadoras auxilia a preparação e a composição
                   do levantamento das variáveis envolvidas.
                """;
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must not be more 255 characters";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
