package com.fabricio.admin.catalogo.infrastructure.category;
...
class CategoryMySQLGatewayTest {
    ...
    void givenAValidCategory_whenCallsUpdate_shouldReturnCategoryUpdated() {
        ...
        Category aCategory = Category.newCategory("Fil", null, expectedIsActive);
        ...
        Assertions.assertEquals("Fil", actualInvalidEntity.getName());
