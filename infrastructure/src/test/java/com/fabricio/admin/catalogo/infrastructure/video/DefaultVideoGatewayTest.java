...
public class DefaultVideoGatewayTest {
    ...
    @Test
    public void givenEmptyParams_whenCallFindAll_shouldReturnAllList() throws Exception {
        // given
        mockVideos();
    ...
    @Test
    public void givenAValidCategory_whenCallFindAll_shouldReturnFilteredList() throws Exception {
        // given
        mockVideos();
    ...
    @Test
    public void givenAValidCastMember_whenCallFindAll_shouldReturnFilteredList() throws Exception {
        // given
        mockVideos();
    ...
    @Test
    public void givenAValidGenre_whenCallFindAll_shouldReturnFilteredList() throws Exception {
        // given
        mockVideos();
    ...
    @Test
    public void givenAllParameters_whenCallFindAll_shouldReturnFilteredList() throws Exception {
        // given
        mockVideos();
    ...
    private void mockVideos() throws Exception {
        videoGateway.create(Video.newVideo(
