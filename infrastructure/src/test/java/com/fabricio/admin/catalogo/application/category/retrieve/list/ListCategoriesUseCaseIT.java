...
public class ListCategoriesUseCaseIT {
    ...
    void mockUp() {
        final var categories = Stream.of(
                        Category.newCategory("Filmes", null, true, 1),
                        Category.newCategory("Netflix Originals", "Títulos de autoria da Netflix", true, 2),
                        Category.newCategory("Amazon Originals", "Títulos de autoria da Amazon Prime", true, 3),
                        Category.newCategory("Documentários", null, true, 4),
                        Category.newCategory("Sports", null, true, 5),
                        Category.newCategory("Kids", "Categoria para crianças", true, 6),
                        Category.newCategory("Series", null, true, 7)
    ...
    public void givenAValidTerm_whenTermDoesntMatchsPrePersisted_shouldReturnEmptyPage() {
        ...
        final var expectedTerms = "adkjf asdkfljasfd";
