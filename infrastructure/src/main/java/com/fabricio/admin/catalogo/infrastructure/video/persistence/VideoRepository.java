package com.fabricio.admin.catalogo.infrastructure.video.persistence;

import com.fabricio.admin.catalogo.domain.video.VideoPreview;
...
public interface VideoRepository extends JpaRepository<VideoJpaEntity, String> {
    ...
    @Query("""
            select distinct new com.fabricio.admin.catalogo.domain.video.VideoPreview(
                v.id as id,
                v.title as title,
