...
import com.fabricio.admin.catalogo.application.category.create.DefaultCreateCategoryUseCase;
import com.fabricio.admin.catalogo.application.category.delete.DefaultDeleteCategoryUseCase;
import com.fabricio.admin.catalogo.application.category.delete.DeleteCategoryUseCase;
import com.fabricio.admin.catalogo.application.category.retrieve.get.DefaultGetCategoryByIdUseCase;
import com.fabricio.admin.catalogo.application.category.retrieve.get.GetCategoryByIdUseCase;
import com.fabricio.admin.catalogo.application.category.retrieve.list.DefaultListCategoriesUseCase;
import com.fabricio.admin.catalogo.application.category.retrieve.list.ListCategoriesUseCase;
import com.fabricio.admin.catalogo.application.category.update.DefaultUpdateCategoryUseCase;
